<main class="contenedor seccion contenido-centrado">
    ...
    <picture>
        <source srcset="build/images/entrada1.webp" type="image/webp">
        <source srcset="build/images/entrada1.jpg" type="image/jpeg">
        <img src="build/images/entrada1.jpg" alt="anuncio" loading="lazy">
    </picture>
