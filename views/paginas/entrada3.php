<main class="contenedor seccion contenido-centrado">
    ...
    <picture>
        <source srcset="build/images/entrada3.webp" type="image/webp">
        <source srcset="build/images/entrada3.jpg" type="image/jpeg">
        <img src="build/images/entrada3.jpg" alt="anuncio" loading="lazy">
    </picture>
