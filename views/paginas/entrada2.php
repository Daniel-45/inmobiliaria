<main class="contenedor seccion contenido-centrado">
    ...
    <picture>
        <source srcset="build/images/entrada2.webp" type="image/webp">
        <source srcset="build/images/entrada2.jpg" type="image/jpeg">
        <img src="build/images/entrada2.jpg" alt="anuncio" loading="lazy">
    </picture>
